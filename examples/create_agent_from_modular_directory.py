...
def main():
    ...
    try:
        ...
        print(f"Loading agent '{args.agent_name}' from directory: {args.agent_directory}")
        agent = AgentUtils.create_agent_from_modular_files(args.agent_directory, args.agent_name)
